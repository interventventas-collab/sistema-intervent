...
public class AppDbContext : DbContext
{
    ...
    public DbSet<CafeClienteProductoDescartado> CafeClienteProductosDescartados => Set<CafeClienteProductoDescartado>();
    ...
    public DbSet<CafeTransporte> CafeTransportes => Set<CafeTransporte>();
    ...
    public DbSet<StockAuditoria> StockAuditorias => Set<StockAuditoria>();
    ...
    // 2026-08-26: alarmas del reloj (por persona del PIN, o por pantalla en Deposito/Contadora).
